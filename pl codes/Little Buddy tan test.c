...

{
    ...
    while(1)
    {
        ...
        strlwr(n);
        system("cls");
        if(strstr(n,"quite")!=NULL || strstr(n,"exit")!=NULL || strstr(n,"stop")!=NULL ||strstr(n,"finish")!=NULL)
        {
            sky2;
        ...
        {
            {
                ...
                else if(strstr(q,"developer")!='\0'||strstr(q,"developer")!='\0'||strstr(q,"devloper")!='\0')
                {
                    ...
                    green2;
                    printf("My developers are TANVIR ISLAM & MOBASSER AHMED.");    // DEVLOPER
                    getch();
                }
                else if(strstr(q,"developer")!='\0'||strstr(q,"developer")!='\0'||strstr(q,"creator")!='\0')
                {

                    green2;
                    printf("My creators are TANVIR ISLAM & MOBASSER AHMED.");     // CREATOR
                    getch();
                }
                ...
                {
                    printf("Ok Bye Bye !!!! , have a nice day :) ");
                    Sleep(1000);
                    break;
                    getch();         // QUITE
                }
                ...
                else if(strstr(q,"love calculator")!='\0' ||strstr(q,"love")!=NULL)          // LOVE CALCULATOR
                {
                    int n,m;
